...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 738.0, 436.0, 84.0, 22.0 ],
					"text" : "read 7.oo.wav"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 838.0, 575.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 806.0, 505.0, 103.0, 22.0 ],
					"text" : "info~ oo.sample"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 651.0, 404.0, 95.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 651.0, 469.0, 105.0, 22.0 ],
					"text" : "buffer~ oo.sample"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 554.0, 391.0, 75.0, 22.0 ],
					"text" : "r media.gain"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 463.0, 419.5, 78.0, 22.0 ],
					"text" : "lg.vol.util.v02"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 507.0, 535.0, 287.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 463.0, 600.0, 61.0, 22.0 ],
					"text" : "send~ in1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 463.0, 448.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 463.0, 364.0, 89.0, 22.0 ],
					"text" : "sfplay~ sounds"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "lg.vol.util.v02.maxpat",
				"bootpath" : "~/OneDrive/Desktop/college/semester 7/Sound Synthesis Techniques & Creative Coding/sound-synth-tech/js.final.project",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
