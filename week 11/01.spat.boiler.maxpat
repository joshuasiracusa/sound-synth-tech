...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1130.746673583984375, 71.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1130.746673583984375, 113.0, 219.0, 36.0 ],
					"presentation_linecount" : 2,
					"text" : ";\r\nspat.oper.msg /source/[1-8]/aperture $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 861.0, 45.5, 42.0, 22.0 ],
					"text" : "/dump"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1007.0, 84.0, 108.0, 20.0 ],
					"text" : "<spat5.osc.view>"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 888.0, 113.0, 227.0, 105.0 ]
				}
...
,
					"patching_rect" : [ 53.0, 51.5, 432.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 721.5, 126.5, 149.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 53.0, 231.5, 203.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "" ],
					"patching_rect" : [ 53.0, 120.5, 432.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 721.5, 45.5, 91.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 721.5, 76.5, 136.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 318.0, 544.5, 119.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 575.5, 120.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 176.0, 544.5, 140.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 176.0, 612.5, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.0, 612.5, 82.0, 22.0 ],
					"text" : "/preset/export"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 176.0, 652.5, 93.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 985.746673583984375, 547.0, 60.0, 20.0 ],
					"text" : "<live.tex>"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 449.999999999999943, 341.5, 179.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 455.999999999999943, 304.0, 268.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.666670262813568, 435.0, 68.0, 22.0 ],
					"text" : "send~ out2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 53.0, 435.0, 68.0, 22.0 ],
					"text" : "send~ out1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 871.746673583984375, 272.5, 393.0, 89.0 ],
...
, 							{
								"box" : 								{
									...
									"text" : ";\r\nmax launchbrowser https://acoustics.org/pressroom/httpdocs/155th/fels.htm"
								}
...
, 							{
								"box" : 								{
									...
									"text" : ";\r\nmax launchbrowser http://www.linux.bucknell.edu/~kozick/elec32007/hrtfdoc.pdf"
								}
...
,
					"patching_rect" : [ 544.746673583984375, 573.0, 152.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 442.746673583984375, 652.5, 151.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 459.963363647460938, 563.5, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 545.746673583984375, 539.5, 150.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 871.746673583984375, 521.5, 99.0, 20.0 ],
					"text" : "some controls —"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 871.746673583984375, 549.5, 112.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 491.963363647460938, 619.5, 29.5, 22.0 ],
					"text" : "/hrtf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 459.963363647460938, 589.5, 41.0, 21.0 ],
					"text" : "kemar"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 442.746673583984375, 619.5, 46.0, 22.0 ],
					"text" : "/hrtf $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 442.746673583984375, 539.5, 101.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
,
					"patching_rect" : [ 524.746673583984375, 619.5, 57.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 11.0,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 53.0, 281.0, 170.0, 116.0 ],
					"relative" : 1,
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 871.746673583984375, 575.5, 237.0, 64.0 ],
					"text" : ";\r\nspat.oper.msg /source/[1-8]/early/mute $1, /source/[1-8]/cluster/mute $1, /source/[1-8]/reverb/mute $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 931.746673583984375, 380.5, 164.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 871.746673583984375, 380.5, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 236.999999999999943, 281.0, 321.0, 116.0 ],
					"relative" : 1,
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_meter_bg"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 871.746673583984375, 409.5, 224.0, 105.0 ],
					"text" : ";\r\nspat.oper.msg /source/number 8, /speaker/number 8, /speakers/aed 0 0 1 45 0 1 90 0 1 135 0 1 -180 0 1 -135 0 1 -90 0 1 -45 0 1, /source/[1-8]/early/mute 1, /source/[1-8]/cluster/mute 1, /source/[1-8]/reverb/mute 1, bang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 752.0, 166.0, 100.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 753.5, 196.0, 97.0, 22.0 ],
					"text" : "/panning/type $1"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 469.463363647460938, 615.5, 452.246673583984375, 615.5 ],
					"source" : [ "obj-101", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 534.246673583984375, 647.5, 452.246673583984375, 647.5 ],
					"source" : [ "obj-105", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 731.0, 218.0, 62.5, 218.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 763.0, 264.0, 39.0, 264.0, 39.0, 225.0, 62.5, 225.0 ],
					"source" : [ "obj-47", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 423.875, 266.0, 548.5, 266.0 ],
					"order" : 0,
					"source" : [ "obj-6", 7 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 372.25, 266.0, 505.357142857142776, 266.0 ],
					"order" : 0,
					"source" : [ "obj-6", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 320.625, 266.0, 462.214285714285666, 266.0 ],
					"order" : 0,
					"source" : [ "obj-6", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 269.0, 266.0, 419.071428571428555, 266.0 ],
					"order" : 0,
					"source" : [ "obj-6", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 217.375, 218.0, 375.928571428571331, 218.0 ],
					"order" : 0,
					"source" : [ "obj-6", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 165.75, 218.0, 332.785714285714221, 218.0 ],
					"order" : 0,
					"source" : [ "obj-6", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 114.125, 218.0, 289.64285714285711, 218.0 ],
					"order" : 0,
					"source" : [ "obj-6", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 62.5, 218.0, 43.0, 218.0, 43.0, 266.0, 246.499999999999943, 266.0 ],
					"order" : 0,
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 7 ],
					"midpoints" : [ 423.875, 218.0, 246.5, 218.0 ],
					"order" : 1,
					"source" : [ "obj-6", 7 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 6 ],
					"midpoints" : [ 372.25, 218.0, 220.214285714285722, 218.0 ],
					"order" : 1,
					"source" : [ "obj-6", 6 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 5 ],
					"midpoints" : [ 320.625, 218.0, 193.928571428571416, 218.0 ],
					"order" : 1,
					"source" : [ "obj-6", 5 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 4 ],
					"midpoints" : [ 269.0, 218.0, 167.642857142857139, 218.0 ],
					"order" : 1,
					"source" : [ "obj-6", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 3 ],
					"midpoints" : [ 217.375, 218.0, 141.357142857142861, 218.0 ],
					"order" : 1,
					"source" : [ "obj-6", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 2 ],
					"midpoints" : [ 165.75, 218.0, 115.071428571428569, 218.0 ],
					"order" : 1,
					"source" : [ "obj-6", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 1 ],
					"midpoints" : [ 114.125, 218.0, 88.785714285714278, 218.0 ],
					"order" : 1,
					"source" : [ "obj-6", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 62.5, 143.0, 62.5, 143.0 ],
					"order" : 1,
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 501.463363647460938, 647.5, 452.246673583984375, 647.5 ],
					"source" : [ "obj-99", 0 ]
				}
		...
		"parameters" : 		{
			"obj-105::obj-11" : [ "live.toggle[23]", "live.toggle", 0 ],
			"obj-105::obj-12" : [ "live.toggle[22]", "live.toggle", 0 ],
			"obj-105::obj-33" : [ "live.menu[2]", "live.menu[2]", 0 ],
			"obj-105::obj-48" : [ "live.toggle[24]", "live.toggle", 0 ],
			"obj-105::obj-8" : [ "live.dial[3]", " ", 0 ],
