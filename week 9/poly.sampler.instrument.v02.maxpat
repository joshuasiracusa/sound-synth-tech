...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 304.0, 611.0, 816.0, 22.0 ],
					"text" : "swap"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 304.0, 563.0, 29.5, 22.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 457.600000000000023, 409.083333333333258, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 290.094594419002533, 398.083333333333258, 50.0, 22.0 ]
				}
...
,
					"patching_rect" : [ 196.0, 212.0, 28.0, 88.0 ],
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 28.0, 438.0, 74.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1105.0, 164.083333333333314, 192.0, 20.0 ],
					"text" : "auto midi notes to test polyphony"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 69.5, 70.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 69.5, 148.0, 60.0, 22.0 ],
					"text" : "s mute.all"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 69.5, 108.0, 59.0, 22.0 ],
					"text" : "mute 1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1110.0, 197.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1110.0, 238.5, 63.0, 22.0 ],
					"text" : "metro 500"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1176.0, 362.5, 58.0, 22.0 ],
					"text" : "s velocity"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1110.0, 362.5, 43.0, 22.0 ],
					"text" : "s pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1110.0, 324.5, 32.0, 22.0 ],
					"text" : "+ 60"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1110.0, 278.5, 66.0, 22.0 ],
					"text" : "random 35"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.0, 468.0, 51.0, 22.0 ],
					"text" : "r to.poly"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 617.0, 50.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 124.0, 617.0, 50.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "", "", "" ],
					"patching_rect" : [ 51.0, 545.0, 150.0, 22.0 ],
					"text" : "poly~ Sampler.Poly.Core 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.594594419002533, 743.0, 825.405405580997467, 22.0 ],
					"text" : "pack f f f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 294.594594419002533, 793.0, 53.0, 22.0 ],
					"text" : "s to.poly"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.5, 503.0, 79.0, 22.0 ],
					"text" : "prepend note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1064.0, 450.0, 56.0, 22.0 ],
					"text" : "r velocity"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 304.0, 452.083333333333258, 41.0, 22.0 ],
					"text" : "r pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 555.0, 131.0, 66.0, 20.0 ],
					"text" : "select all"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 466.0, 131.0, 87.0, 20.0 ],
					"text" : "select end ms"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 387.0, 124.0, 70.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 308.0, 124.0, 76.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 229.0, 124.0, 70.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 439.180180132389069, 347.747747540473938, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 359.0, 347.747747540473938, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.594594419002533, 347.747747540473938, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 222.522522389888763, 347.747747540473938, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 304.0, 480.0, 816.0, 68.0 ],
					"range" : 88
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 904.5, 438.0, 150.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 545.0, 169.0, 53.0, 22.0 ],
					"text" : "0 -1 0 -1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 466.0, 169.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 387.0, 169.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 308.0, 169.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 229.0, 169.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 837.5, 92.0, 119.0, 34.0 ],
					"text" : "<= 1. drop a sample (sound flle)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 837.5, 72.0, 68.0, 20.0 ],
					"text" : "<live.drop>"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 968.0, 278.5, 69.0, 20.0 ],
					"text" : "<= duration"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 8.0, 622.0, 27.0 ],
					"text" : "Monophonic Sampler Instrument with <kslider> and <bach.roll> Control"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 550.285714285714221, 18.0, 234.0, 75.0 ],
									"text" : "Taken from our Wyschnegradsky patch.\n\nOnce you have this hooked up in the parent patch, play the <bach.roll> to hear its control over the sampler instrument."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 643.285714285714221, 406.833333333333371, 331.0, 48.0 ],
									"text" : "<= <makenote> accepts MIDI integers, floats, or midicents!\n      Here, we divide by 100. to use with reference pitch (in     \n      parent patch)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 643.285714285714221, 519.833333333333371, 133.0, 20.0 ],
									"text" : "<= send to synthesizer!"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 643.285714285714221, 491.833333333333371, 302.0, 20.0 ],
									"text" : "<= format note-on and note-off based on duration value"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 643.285714285714221, 462.833333333333371, 231.0, 20.0 ],
									"text" : "<midicents>  <velocity> <duration> <flag>"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 643.285714285714221, 355.833333333333371, 228.0, 20.0 ],
									"text" : "<midicents> <duration> <velocity> <flag>"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 643.285714285714221, 326.833332999999982, 337.0, 20.0 ],
									"text" : "<= double-click to see the logic. Syntax: e.g. 4100. 525. 100 0"
								}
...
,
									"patching_rect" : [ 449.714286000000016, 326.833332999999982, 167.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 497.714285714285779, 519.833333333333371, 58.0, 22.0 ],
									"text" : "s velocity"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 449.714285714285779, 519.833333333333371, 43.0, 22.0 ],
									"text" : "s pitch"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 449.714285714285779, 406.833333333333371, 39.0, 22.0 ],
									"text" : "/ 100."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 449.714285714285779, 462.833333333333371, 125.0, 22.0 ],
									"text" : "pack f f f"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 449.714285714285779, 491.833333333333371, 67.0, 22.0 ],
									"text" : "makenote"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 449.714285714285779, 355.833333333333371, 175.0, 22.0 ],
									"text" : "unpack f f f i"
								}
...
, 							{
								"box" : 								{
									...
									"out" : "nnnnnnn",
									"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
									"patching_rect" : [ 16.0, 18.0, 525.0, 303.833333333333371 ],
									"pitcheditrange" : [ "null" ],
									"ruler" : 3,
									"showplayhead" : 1,
									"stafflines" : [ 5 ],
...
,
					"patching_rect" : [ 991.0, 78.0, 167.0, 31.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 882.5, 271.5, 82.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 819.5, 197.5, 103.0, 22.0 ],
					"text" : "info~ mySample"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 54.5, 743.0, 54.0, 22.0 ],
					"text" : "*~ 0.707"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 138.166670262813568, 784.0, 68.0, 22.0 ],
					"text" : "send~ out2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 54.5, 784.0, 68.0, 22.0 ],
					"text" : "send~ out1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 51.0, 589.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 695.5, 42.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 782.5, 229.5, 95.0, 22.0 ],
					"text" : "set mySample 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 695.5, 136.5, 95.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 695.5, 164.083333333333314, 106.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 695.5, 72.0, 140.0, 60.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 428.100000000000023, 438.0, 291.0, 438.0, 291.0, 729.0, 707.297297209501266, 729.0 ],
					"order" : 0,
					"source" : [ "obj-10", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 364.899999999999977, 333.0, 345.0, 333.0, 345.0, 384.0, 351.0, 384.0, 351.0, 438.0, 291.0, 438.0, 291.0, 729.0, 505.6959458142519, 729.0 ],
					"order" : 0,
					"source" : [ "obj-10", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 313.5, 729.0, 908.898648604750633, 729.0 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-67", 0 ],
					"midpoints" : [ 313.5, 588.0, 291.0, 588.0, 291.0, 432.0, 426.0, 432.0, 426.0, 327.0, 867.0, 327.0, 867.0, 267.0, 892.0, 267.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "Sampler.Poly.Core.maxpat",
				"bootpath" : "~/OneDrive/Desktop/college/semester 7/Sound Synthesis Techniques & Creative Coding/sound-synth-tech/week 9",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
